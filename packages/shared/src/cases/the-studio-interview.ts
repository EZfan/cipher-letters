...
export const theStudioInterview: Case = {
  ...
  ghost: {
    ...
    willAdmit:
      '"I am two people. The other one is not here. She is, however, in the room."',
  },
  surfaceNarrative:
  ...
  clues: [
    {
      ...
      ghostHints: ['The album.', 'You say "the album" as if there is only one. There is. It is not mine.'],
    },
    {
      id: 'C2',
      surfaceMeaning: 'She says "I have not recorded in this studio before"',
      hiddenMeaning: 'She has. Clara rehearsed here for years. Vivian is lying to maintain the fiction.',
    ...
    },
    {
      ...
      hiddenMeaning: 'She does not experience "her" voice as her own. It is Clara\'s voice, on loan.',
      appearsIn: 'Several places',
      ghostHints: ['It is not mine.', 'It is on loan. It will go back.'],
    },
    {
      id: 'C6',
      surfaceMeaning: 'The microphone is described three times as "the new one" or "the better one"',
    ...
    },
    {
      ...
      hiddenMeaning: 'There was a fire. The correction is a Freudian slip; the journalist did not catch it.',
    ...
    },
    {
      ...
      hiddenMeaning: 'The fire alarm is the only thing in this transcript that is not staged. Vivian triggered it to end the interview before she said Clara\'s name.',
  ...
  redHerrings: [
    {
      id: 'R1',
      description: 'Vivian\'s mention of a "difficult label executive" who wanted to change her image',
    ...
    },
    {
      ...
      ghostDeflection: '"She — I — yes. The smoke is in the booth. The microphone will remember it."',
    },
  ],
  difficulty: 'hard',
