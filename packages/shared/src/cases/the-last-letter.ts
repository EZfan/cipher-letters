...
export const theLastLetter: Case = {
  ...
  clues: [
    ...
    },
    {
      ...
      hiddenMeaning:
        'Elisabeth came for the funeral and has not left because Marlene will not be alone.',
    ...
    },
    {
      ...
      hiddenMeaning:
        'Father Keller has called twice to discuss the funeral arrangements — which Marlene has not finalized.',
      appearsIn: 'Middle paragraph',
    ...
    },
    {
      ...
      hiddenMeaning:
        "The blue envelope is this letter, sealed and placed in the drawer where Erich's things are kept.",
    ...
    },
    {
      ...
      hiddenMeaning:
        "The holiday is the funeral trip to the Alps — Erich's last wish, which Marlene could not fulfill.",
    ...
    },
    {
      ...
      hiddenMeaning:
        "The twenty-ninth is not their wedding anniversary but the date of Erich's death.",
